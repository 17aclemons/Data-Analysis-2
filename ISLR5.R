...
####4####
#Question 4) Now that you're familiar with bootstrapping, walk through the process (in words) on how you would calculate the variance of a model prediction?
